...
Autor: Kastwey
Fecha: 19/02/2006
Descripción: Arena de las kisalas, con árbol para trepar
****************************************************************************/
...
public int cmd_trepar(string str)
{
    ...
    if ((pl = TP)->QueryTP() < 5)
    {
        return notify_fail("Estás demasiado cansada para escalar ahora.\n",
                           NOTIFY_NOT_VALID);
    }
...
create()
{
    ...
    SetIntLong("Al norte puedes ver una de las paredes del edificio del "
               "gremio, mientras que al este, oeste y nordeste continúa el bosque. "
               "Al sur, divisas las aguas del lago Zinn, y más allá, la isla "
               "de Goldhai.\n"
               "Casi al borde mismo del agua, observas que uno de los árboles, "
               "el más alto de los alrededores, tiene unas cuerdas atadas "
               "por las que te sería relativamente fácil trepar.\n");
    ...
    AddDetail(({"arbol","árbol","arbol alto","árbol alto","árbol grande",
                ...
                "trepar. Bajo él, y extendiéndose hacia el este hasta otro árbol "
    ...
    AddDetail("red", "Se trata de una red formada por gruesas cuerdas entrelazadas, "
              ...
              "extiende hacia el este, junto a otro árbol de proporciones "
