...
{
    ::create();
    SetShort("el pergamino de elemental de fuego");
    SetLong("Se trata de un pergamino bastante deteriorado.\nTe fijas un poco más y puedes "
        ...
        "encabezado lees 'Conjuro elemental de fuego'.\nquizás si lo intentases hasta podrías "
        "hacerlo o incluso memorizarlo.\n");
    SetIds(({"pergamino","elemental de fuego","hoja","papel"}));
    SetValue(6500);
    SetWeight(100);
    ...
    SetCanCast(1);
    SetMaxCast(1);
    SetScrollID("elemental de fuego");
