...
Opciones:
AdjustMoney(mapping) -> añade ese dinero
AdjustMoney(pointer) -> añade ese dinero
AdjustMoney(int, string) -> añade int monedas del tipo string
AdjustMoney(int) -> añade int monedas de cobre de forma simplificada
*/
varargs int AdjustMoney(mixed amnt, string type) {
  ...
  /* algun capullo ha puesto los parametros al revés */
