...
// Abbreviations.
#define WizSearch() ((!query_wiz_level(this_player()) || this_player()->Query(P_NOWIZ)) ? 0 : SM_IGNLIGHT)
#define TWizSearch() ((!query_wiz_level(this_player()) || this_object()->Query(P_NOWIZ)) ? 0 : SM_IGNLIGHT)
