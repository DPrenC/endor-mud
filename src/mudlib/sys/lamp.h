...
#define PLM_NO_LIGHTER  9 /* the player have not lighter */
#define PLM_NO_FIRE     10 /* cannot start the fire */
#define PLM_NO_FIRE_E   11 /* cannot start the fire for environment */
#define PLM_MAX_MSGS 12
