...
#define WHIMPY_NORMAL	0	//no deberia usarse... metodo viejo
#define WHIMPY_HB	1 //(1<<0) //llamada desde mi heartbeat
#define WHIMPY_FORCE	2 //(1<<1) //algo le fuerza a huir
...
// Los campos del array de P_IS_FOLLOWER:
#define FOLLOW_MODE	0
#define FOLLOW_OBJECT	1

// los valores de FOLLOW_MODE en P_IS_FOLLOWER
#define FOLLOW_NO	0 //NO sigue a nadie
#define FOLLOW_ALWAYS	1 //sigue SIEMPRE
#define FOLLOW_NORMAL	2 //sigue EXCEPTO en M_TELEPORT y M_SPECIAL
...
#define ME_TOO_MANY       10 /* demasiados objetos */
#define ME_TOO_BIG        11 /* demasiado grande */
#define ME_CLOSED         12 /* cerrado */
