/*
Fichero: bcaminodeleste.c
Autor: aulë
Fecha: 04/08/2013
Descripción: Base del camino que une la puerta sur de Bree y discurre hacia el este hasta salir del dominio hacia Eriador. 
*/
#include "./path.h"
inherit BREE_ROOM;
create()
