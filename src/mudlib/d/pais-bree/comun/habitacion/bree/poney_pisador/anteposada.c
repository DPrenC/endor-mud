/*
Fichero: base_aldea.c
Autor: aulë
Fecha: 31/08/2014
Descripción:  base de las rooms exteriores de la aldea de Bree.
*/
#include "./path.h"
inherit BREE_ROOM;
#include <moving.h>
...
string f_sonidos(){
    switch(d20()){
    case 1:
    	return "Oyes un portazo lejano.\n";
    	case 2:
    		return "Se oye el cacareo de algunas aves en un corral cercano.\n";
    		case 3:
    			return "Un gato maulla melancólicamente cerca de aquí.\n";
    			case 4:
    				return ".\n";
    				case 5:
