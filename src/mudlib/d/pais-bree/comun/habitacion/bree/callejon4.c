...
create()
{
    ::create();
    	...
    	"Al este el callejón desemboca en un camino que desciende de la colina y jalona la "
    	"posada por detrás y al oeste se extiende el callejón que comunica con el camino "
