...
Autor: aulë
Fecha: 04/08/2013
Descripción: Base del paseo que bordea la parte alta de la colina, a donde dan las puertas de los agujeros hobbits de la aldea. 
*/
#include "./path.h"
...
{
    ::create();
SetIntShort("un ancho paseo de gravilla.\n");
    	    	    switch(d3()){
        case 1:
     SetIntLong(
