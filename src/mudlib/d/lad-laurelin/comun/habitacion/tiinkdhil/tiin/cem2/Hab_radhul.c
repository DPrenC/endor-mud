...
create()
{
  ...
  SetIntLong(
    ...
    "Ricos cortinajes cubren las paredes, dandole un aire noble y pomposo. Candelabros bellamente tallados dan una iluminacion parcial que permite un ambiente suave.Un aire enrarecido asalta\n"
  ...
  SetIntNoise(
    "Una musica suave que no sabrias decir de donde viene te incita a pensamientos extraños.\n"
    );
  AddDetail(({"niebla"}),
  ...
  AddDetail(({"candelabros","candelabro"}),
    "Unos hermosos candelabros labrados estan fijos a las paredes en forma de pequeñas antorchas. La cera cae en cascadas por las velas que iluminan la estancia.\n"
    );
  AddDetail(({"humo"}),
    "De la pared sale un poco de humo que identificas como incienso.\n"
    );
  AddDetail(({"pared"}),
    "Pequeños agujeros permiten la salida de humo.\n"
    );
  AddExit("norte","camino6.c");
