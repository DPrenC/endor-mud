...
SetIntLong("  Te encuentras en el cementerio, la luz se hace mas tenue y empiezas a ver\n"
           "una niebla densa que se levanta a corta distancia del suelo pero que a lo\n"
...
SetIntNoise(
"  Se puede oir la suave brisa del viento,que mueve la hierba. Se oye algo mas\n"
