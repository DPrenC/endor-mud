...
create()
{
  ...
  AddDetail(({"niebla"}),
    "Una fina capa de niebla cubre el suelo de manera amenazante, dando a este lugar un aspecto tetrico y olvidado de la mano de dios.\n"
    );
  AddDetail(({"calaveras"}),
    "Unas figuras de calaveras adornan esta sala. Tienen un aspecto muy real.\n"
    );
  AddDetail(({"tumba"}),
    "Una especie de sarcofago de piedra, adornado con calaveras se alza en el centro de esta sala.\n"
    );
  AddExit("este","camino6.c");
