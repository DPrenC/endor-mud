...
create()
{
  ...
  SetIntLong(
    "Este mausoleo tiene un gran sarcofago en el centro de la sala. Adornado con craneos y de aspecto temible es lo unico que se ve en la sala a estilo de decoracion. Extrañamente, parece mas limpio que el resto de sitios en los que has estado hasta llegar aqui.\n"
    );
  SetIndoors(1);
  SetIntBright(30);
  SetIntSmell(
  ...
  AddDetail(({"craneos"}),
    ...
    "Quien querria tener su sueño final en un lugar como este, te preguntas.\n"
    );
  AddDetail(({"sarcofago"}),
