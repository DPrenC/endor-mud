...
create()
{
  ...
  SetIntLong(
    "En este lado del cementerio las lapidas se amontonan contra una de las paredes, la niebla parece viva y te hace pensar cosas extrañas. A lo lejos hacia el este se distinge una pared, hacia el oeste solo ves un camino con tumbas a los lados que parece perderse en un mar de niebla.\n"
    );
  SetIndoors(0);
  SetIntSmell(
  ...
  AddDetail(({"lapidas"}),
    "Lapidas amontonadas y con aspecto de haber sido arrancadas estan amontonadas contra una pared cercana.\n"
    );
  AddDetail(({"tumbas"}),
  ...
  AddExit("oeste","camino5.c");
  AddExit("este","camino11.c");
