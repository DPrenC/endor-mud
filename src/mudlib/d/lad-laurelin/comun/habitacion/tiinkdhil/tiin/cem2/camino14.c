...
create()
{
  ...
  SetIntLong(
    "Estas en el camino derecho del cementerio, en este lado un par de mausoleos de aspecto desaliñado y matratado por el tiempo se alzan haciendo de la vista algo monotono. Unos pequeños arboles adornan los laterales del camino, dandole un toque tetrico a la escena.\n"
    );
  SetIndoors(0);
  SetIntSmell(
