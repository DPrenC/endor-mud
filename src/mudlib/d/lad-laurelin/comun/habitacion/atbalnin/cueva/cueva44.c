...
create(){
  ...
  SetIntLong(W("Estás frente a un pedestal blanco. A su alrededor hay diversas "
  	"figuras que forman curiosas formas. Sobre el pedestal hay un libro.\n"));
  AddDetail("libro", "Es el libro de la Perduración.\n");
  AddDetail(({"figura", "figuras"}), "Hay un círculo de figuras que rodean "
  	"el pedestal.\n");
  AddDetail("pedestal", "Es de mármol blanco. En el centro hay un libro.\n");
