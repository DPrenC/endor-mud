...
create()
{
 ...
 SetIntLong("La muralla norte es un extranyo lugar elegido para pasear, pero tu veras que haces.\n"
		"Desde aqui puedes oir los pasos de muchos guardias y puedes contemplar un hermoso\n"
		"paisaje y los pasillos de la historia de Sigil.\n");
 SetIndoors(1); 

 SetIntBright(MAX_SUNBRIGHT/2);

 SetIntNoise("Todo es tranquilo y silencioso, excepto por los largos y monotonos paseos de\n"
		 "los guardias de los portales de Sigil.\n");
