...
create()
{
 ...
 SetIntLong("En estos instantes estas en la muralla norte de Sigil, desde aqui puedes ver\n"
		"principalmente la gran torre de magia y los pasillos de la historia elfica.\n");
 SetIndoors(1); 
