...
create()
{
 ...
 SetIntLong("Estas en la muralla norte de Sigil desde aqui se ven algunos guardias elfos paseando\n"
		"por el oeste. Tienes unas hermosas vistas del paisaje desde aqui y tambien puedes\n"
		"apreciar la grandeza de los pasillos de la historia de Sigil.\n");
 SetIndoors(1); 

 SetIntBright(MAX_SUNBRIGHT/2);

 SetIntNoise("Todo es tranquilo y silencioso, hacia el oeste escuchas algunos pasos.\n");
