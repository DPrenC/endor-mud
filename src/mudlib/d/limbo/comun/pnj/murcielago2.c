/*
DESCRIPCION  : murcielago agresivo para la mina de novatos
FICHERO      : /d/limbo/comun/pnj/murcielago2.c
...
create() {
  ...
  InitChats(8,({
   ...
   "El murcielago atrapa algún tipo de bicho que revoloteaba cerca.\n"}));
