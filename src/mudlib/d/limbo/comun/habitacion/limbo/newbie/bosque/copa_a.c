...
create()
{
    ...
    SetIntLong("¡Desde aquí se observa mejor el paisaje! Te hallas en la parte media de la copa de uno de los árboles del "
        "parque de entrenamiento. Las ramas en las que te apoyas se doblan bajo el efecto de tu peso y no crees "
        "conveniente subir mucho más arriba, donde las ramas son aún más delgadas.\n");
