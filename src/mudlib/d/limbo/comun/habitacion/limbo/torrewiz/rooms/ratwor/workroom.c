...
Autor: Ratwor
Fecha: 24/04/2008
Descripción: la workroom de Ratwor
****************************************************************************/
...
create(){
    ::create();
    SetIntShort("los aposentos de Ratwor");
    ...
    "paredes, destacan un tapiz y unos cuadros de sutil simbología. En el primer tercio de "
    ...
    AddDetail(({"cuadros", "cuadro", "pared", "paredes"}),
    "Las paredes este y oeste están completamente tapadas por distintos cuadros, "
    "mientras que en la del norte, junto a la puerta de entrada, hay un sugerente tapiz.\n");
    AddDetail(({"cuadro este", "cuadro del este", "este", "pared este", "pared del este"}),
    ...
    AddDetail(({"oeste", "cuadro oeste", "cuadro del oeste", "pared oeste", "pared del oeste"}),
    ...
    AddExit("sur", "./terraza");
    AddDoor("norte", "una puerta oscura",
    "Es una puerta de madera oscura, suave y reluciente, sin ningún adorno.\n",
    ({"puerta", "puerta oscura", "puerta de madera", "puerta del norte"}));
