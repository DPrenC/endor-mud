/*
DESCRIPCION  : una gran cofre de madera con ropa
FICHERO      : /d/akallab/comun/objeto/mueble/cofre_ropa.c
...
create () {
  ...
  int cobre, plata;
  ::create();
  SetShort ("un gran cofre");
  SetIntShort ("dentro de un gran cofre de madera");
  SetLong ("Un gran cofre de madera sin nada de especial.\n");
  SetIntLong ("Estas en el interior de un gran cofre dee madera.\n");
  SetPreContent ("Contiene:\n");
  SetValue (200);
  SetWeight (10000);
  SetMaxIntWeight (20000); // 20 kg carga
  Set(P_NOGET,1);
  AddId ("cofre");
