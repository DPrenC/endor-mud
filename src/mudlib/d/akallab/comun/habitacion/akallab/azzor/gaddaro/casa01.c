...
FICHERO      : /d/akallab/comun/habitacion/akallab/azzor/gaddaro/casa01.c
...
create() {
 ...
 SetIntShort("una casa del pueblo de Gaddaro");
  ...
  "chimenea de piedra. Es austera, sin apenas decoración alguna. Junto a la "
  "chimenea se halla un banco de madera donde sentarse al abrigo del calor "
  "de la lumbre y mas allá un camastro.\n");
  ...
  AddDetail(({"camastro"}),
  "Es una especie de cajón bajo de madera relleno de paja.\n");
  ...
  "Gaddaro es el nombre de este pequeño pueblo situado en el noroeste del "
