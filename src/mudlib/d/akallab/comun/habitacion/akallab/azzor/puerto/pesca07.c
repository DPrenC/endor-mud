...
FICHERO     : /d/akallab/comun/habitacion/akallab/azzor/puerto/pesca07.c
MODIFICACION:
...
#define MUELLE (AZ_PUERTO("muelle07"))
...
SetIntShort("una barca de pesca");
 SetIntLong(
  ...
  "a las olas. El foque está libre y la vela mayor sujeta la botavara bajada. En el "
  "suelo de la barca hay varias redes enrolladas y en la popa, junto al timón, varios "
  "cubos con fuerte olor a pescado.\n");

#include "pesca_detail.ic"

  AddExit("muelle",SF(ir_muelle));
  //AddExit("muelle",AZ_PUERTO("muelle07"));
