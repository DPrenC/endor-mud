...
create()
{
	...
	::create();
	AddExit(DIR_TORRE_2,AZ_MURALLA_PO("p1t2camas2"));
	AddExit(DIR_CIUDAD,AZ_MURALLA_PO("p1t2escalera"));
	AddExit(DIR_TORRE_1,AZ_MURALLA_PO("p1t2puerta"));
	AddExit(DIR_FUERA,AZ_MURALLA_PO("p1t2centro2"));
}
