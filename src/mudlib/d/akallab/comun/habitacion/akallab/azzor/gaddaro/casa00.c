...
FICHERO      : /d/akallab/comun/habitacion/akallab/azzor/gaddaro/casa00.c
...
create() {
 ...
 SetIntShort("una casa del pueblo de Gaddaro");
  ...
  "chimenea de piedra. Es austera, sin apenas decoracion alguna. Junto a "
  "la chimenea se halla un banco de madera donde sentarse al abrigo del "
  "calor de la lumbre.\n");
  ...
  "Gaddaro es el nombre de este pequeño pueblo situado en el noroeste "
  "del valle de Azzor. Sus habitantes se dedican basicamente a la "
  "agricultura y a la pesca en el cercano lago Darum.\n");
