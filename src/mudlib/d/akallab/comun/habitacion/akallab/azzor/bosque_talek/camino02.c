...
create()
{
   ...
   SetIntLong("Continúas avanzando por el Camino del Este que atraviesa el "
    ...
    AddDetail(({"tronco","viejo tronco","robles","hueco"}),"Junto al camino "
        ...
        "ver a un par de jóvenes robles compitiendo por el hueco donde antes "
        "crecía ese árbol.\n");
    AddExit("noroeste",BOSQUE_TALEK("camino01"));
    AddExit("este",BOSQUE_TALEK("camino03"));
    AddExit("norte",BOSQUE_TALEK("bosque34"));
    AddExit("sur",BOSQUE_TALEK("bosque26"));
}
