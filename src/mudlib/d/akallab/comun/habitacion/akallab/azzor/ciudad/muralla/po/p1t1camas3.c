...
create()
{
	...
	::create();
	AddExit(DIR_CIUDAD_TORRE_1,AZ_MURALLA_PO("p1t1armario1"));
    AddExit(DIR_CIUDAD_TORRE_2,AZ_MURALLA_PO("p1t1armario2"));
	AddExit(DIR_CIUDAD,AZ_MURALLA_PO("p1t1centro2"));
}
