...
FICHERO      : /d/akallab/comun/habitacion/akallab/azzor/gaddaro/campo01.c
...
create() {
  ...
  SetIntLong(
  "Estas en medio de los campos de trigo de la fertil vega de Gaddaro. A tu "
...
//#include AZ_CAMINO("ambiente.ic")

 SetIntNoise("Oyes a los pajaros cantar.\n");

 AddExit("norte",AZ_CAMINO("camino14"));
 AddExit("oeste",AZ_CAMINO("camino15"));
