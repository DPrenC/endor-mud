...
create()
{
	...
	::create();
	AddExit(DIR_FUERA_TORRE_1,AZ_MURALLA_PO("p1t1camas3"));
    AddExit(DIR_TORRE_1,AZ_MURALLA_PO("p1t1centro2"));
	AddExit(DIR_CIUDAD,AZ_MURALLA_PO("p1t1puerta"));
}
