...
create()
{
   ...
   SetIntLong("El camino continúa avanzando por el interior del bosque "
    ...
    AddDetail(({"tocón","viejo tocón"}),"El tocón es la parte baja del "
        "tronco que está unida a las raíces del árbol. Alguien debió talar "
        "un gran árbol que crecía junto al camino y ahora solo su tocón "
        "recuerda que alguna vez estuvo aquí. Seguro que algún cansado "
        "viajero lo ha usado como asiento más de una vez.\n");
