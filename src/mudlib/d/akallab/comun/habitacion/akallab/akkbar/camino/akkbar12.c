...
FICHERO      : /d/akallab/comun/habitacion/akallab/akkbar/camino/akkbar12.c
...
create()
{
   ...
   SetIntShort("el paso de Akkbar");
    SetIntLong("Tras avanzar por este angosto desfiladero has llegado a un "
        ...
        "avanzar más por él. Aunque esta zona está más bien abrigada, no "
        "puedes dejar de sentir el frío que en estas montañas ha calado en "
        "tus huesos. Desearías estar en cualquier otro lugar.\n");
    ...
    SetIndoors(0);
    AddExit("nordeste",AKKBAR_CAMINO("akkbar11"));
    AddItem(QUEST+"curandera/edelweiss",REFRESH_REMOVE,1);
}
