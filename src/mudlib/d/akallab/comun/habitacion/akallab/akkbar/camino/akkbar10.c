...
FICHERO      : /d/akallab/comun/habitacion/akallab/akkbar/camino/akkbar10.c
...
create()
{
   ...
   SetIntShort("el paso de Akkbar");
    SetIntLong("Has llegado a un punto en este desfiladero encajonado entre "
        "la ladera de dos montañas en el que la pendiente es tan grande que "
        "te hace imposible avanzar más por él. Tendrás que volver hacia "
        "atrás en tu camino. Esta zona está más abrigada y se siente menos "
        "el efecto del frío viento que recorre el paso.\n");
    ...
    SetIndoors(0);
    AddExit("nordeste",AKKBAR_CAMINO("akkbar01"));
