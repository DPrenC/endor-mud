...
FICHERO      : /d/akallab/comun/habitacion/akallab/akkbar/camino/akkbar05.c
...
create()
{
   ...
   SetIntShort("el paso de Akkbar");
    SetIntLong("El viento sopla frío con fuerza aquí en el fondo del "
        ...
        "nieves perpetuas. Un estrecho desfiladero se abre al norte de aquí.\n");
    ...
    SetIndoors(0);
    AddExit("norte",AKKBAR_CAMINO("akkbar13"));
    AddExit("suroeste",AKKBAR_CAMINO("akkbar04"));
    AddExit("este",AKKBAR_CAMINO("akkbar06"));
}
