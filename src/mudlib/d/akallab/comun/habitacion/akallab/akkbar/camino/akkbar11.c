...
FICHERO      : /d/akallab/comun/habitacion/akallab/akkbar/camino/akkbar11.c
...
create()
{
   ...
   SetIntShort("el paso de Akkbar");
    SetIntLong("Avanzas por un estrecho desfiladero entre las Montañas "
        "Negras. El clima es frío, la vegetación escasa y las altas montañas "
        "cubiertas de nieves perpetuas son tu única compañía. Un viento frío "
        "sopla con fuerza por el desfiladero.\n");
    ...
    SetIndoors(0);
    AddExit("norte",AKKBAR_CAMINO("akkbar03"));
    AddExit("suroeste",AKKBAR_CAMINO("akkbar12"));
