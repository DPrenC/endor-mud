/*
DESCRIPCION  : Salida al valle de Zarkam
FICHERO      : /d/akallab/comun/habitacion/akallab/akkbar/camino/akkbar00.c
...
int ir_o()
{
    if (TP->QueryIsPlayer()) return TP->move(Z_CAMINO("ce_15"),M_GO);
    return 1;
}
...
create()
{
   ...
   SetIntShort("la salida del paso de Akkbar");
    ...
    SetIndoors(0);
    AddExit("sudeste",AKKBAR_CAMINO("akkbar01"));
