...
FICHERO      : /d/akallab/comun/habitacion/akallab/zarkam/c_camp04.c
...
int ir_se()
{
if (TP->QueryIsPlayer()) return TP->move(Z_CAMINO("c_camp03"),M_GO);
  return 1;
}
...
{
 SetIntLong(
    "A tu alrededor se extienden los campos de cultivo de los orcos en este "
    "valle.\n" + mirar_trigo() +
    "Te encuentras en el camino que atraviesa estos campos. Al noroeste de aqui un "
...
create() {
 ...
 AddDetail(({"tierras de cultivo","cultivos","campos de cultivo"}),
  ...
  AddExit("noroeste",Z_CAMPOS("c_camp05"));
}
