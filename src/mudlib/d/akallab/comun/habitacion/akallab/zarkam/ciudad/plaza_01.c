...
create() {
  ...
  SetIntLong(
    ...
    "hay construido un patibulo del que cuelgan varias horcas. Los edificios que "
    "rodean la plaza son los mas altos y ricos de la ciudad, pero no son comparables "
"con el impresionante castillo del gobernador que se alza al oeste. La calle "
    "mayor de Zarkam parte desde aqui hacia la puerta norte de la ciudad. "
    "Aqui suelen detenerse las caravanas que pasan por la ciudad y al este "
    "se halla la parada de las diligencias.\n");

  AddDetail(({"parada"}),
    "En el edificio que queda al este de aqui es la parada de la diligencia. Es "
    "el lugar al que llegan las diligencias a la ciudad procedentes de otros "
    "sitios. Alli podras comprar un billete o informarte de los horarios de las "
    "que regularmente parten de Zarkam.\n");
  ...
  AddCaravana(CAR_ZARKAM("caravana"));
}
