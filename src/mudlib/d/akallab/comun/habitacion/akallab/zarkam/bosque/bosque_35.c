...
create() {
  ::create();
  SetIntShort("el puente sobre el Zarmaii");
  SetIntLong(
...
"Atravesando el puente hacia el noroeste podrias llegar facilmente a la otra "
"orilla.\n");
  SetIndoors(0);
  AddExit("noroeste",Z_BOSQUE("bosque_44"));
  AddExit("norte",Z_BOSQUE("bosque_45"));
  AddExit("sudeste",Z_BOSQUE("bosque_26"));
  AddExit("suroeste",Z_BOSQUE("bosque_24"));
  AddExit("oeste",Z_BOSQUE("bosque_34"));
