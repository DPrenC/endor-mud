...
FICHERO      : /d/akallab/comun/habitacion/akallab/zarkam/mina/nivel0/caverna1.c
...
create() {
  ...
  "Te encuentras frente a la entrada de una de las casetas de madera que "
	...
	"y al oeste de aqui estan las entradas de dos galerias que se adentran "
	"en las profundidades de las montanyas en busca de vetas de mineral.\n");
  ...
  AddExit("este",Z_MINAS("/nivel0/caverna2"));
  AddExit("oeste",Z_MINAS("/nivel0/caverna0"));
  AddExit("sur",Z_MINAS("/nivel0/caverna4"));
  //AddExit("norte",Z_MINAS("/nivel0/oficina0"));
}
