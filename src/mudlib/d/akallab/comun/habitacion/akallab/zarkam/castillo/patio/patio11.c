...
FICHERO     : /d/akallab/comun/habitacion/akallab/zarkam/castillo/patio11.c
...
create() {
 ...
 SetIntLong(
     ...
     "Zarkam. Al este de aqui ves como una pasarela elevada conecta la muralla con la "
  ...
  AddDetail(({"pasarela"}),
     ...
     "planta del castillo al este de aqui.\n");
  ...
  AddExit("oeste",Z_CASTILLO("patio/patio12"));
  AddExit("este",Z_CASTILLO("patio/patio06"));
}
