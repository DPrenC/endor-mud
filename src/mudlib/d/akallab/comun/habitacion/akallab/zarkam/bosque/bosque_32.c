...
"los extranyos aullidos que oyes de vez en cuando.\n");
  SetIndoors(1);
  SetIntBright(10);
  AddExit("este",Z_BOSQUE("bosque_33"));
  AddExit("sudeste",Z_BOSQUE("bosque_23"));
  AddExit("nordeste",Z_BOSQUE("bosque_43"));
  AddExit("oeste",Z_BOSQUE("bosque_31"));
  AddExit("norte",Z_BOSQUE("bosque_42"));
