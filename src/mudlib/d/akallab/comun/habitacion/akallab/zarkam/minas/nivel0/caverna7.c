...
FICHERO      : /d/akallab/comun/habitacion/akallab/zarkam/mina/nivel0/caverna7.c
...
create() {
  ...
  SetIntLong(
  "Justo al sur de aqui comienza una de las galerias que parten de esta "
  ...
  AddExit("este",Z_MINAS("/nivel0/caverna8"));
  AddExit("norte",Z_MINAS("/nivel0/caverna4"));
  AddExit("oeste",Z_MINAS("/nivel0/caverna6"));
  AddExit("sur",Z_MINAS("/nivel0/galer00"));
}
