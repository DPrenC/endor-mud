...
create() {
  ...
  SetIntLong(
"El bosque es realmente denso, te encuentras rodeado de arboles que te impiden "
"el paso en muchas direcciones. Solo en algunos lugares por la poca proximidad de "
...
"gigantescos monstruos te lo impiden.\n");
  SetIndoors(1);
  SetIntBright(10);
  AddExit("este",Z_BOSQUE("bosque_09"));
  AddExit("nordeste",Z_BOSQUE("bosque_18"));
  AddExit("sudeste",Z_BOSQUE("bosque_01"));
