...
FICHERO     : /d/akallab/comun/habitacion/akallab/zarkam/ciudad/torre_05.c
...
create() {
 ...
 SetIntLong(
    "Te hallas en el interior de la torre oeste de la puerta norte de la ciudad, "
    "donde viven los guardias de la puerta. Al fondo de la habitacion un lento fuego "
...
AddExit("arriba",Z_CIUDAD("torre_06"));
AddExit("este",Z_CIUDAD("calle_06"));
}
