...
FICHERO     : /d/akallab/comun/habitacion/akallab/zarkam/castillo/patio14.c
...
create() {
 ...
 SetIntLong(
     "Este amplio corredor continua avanzando entre la muralla y el castillo de "
     "Zarkam. Al norte de aqui ves como una pasarela elevada conecta la muralla con la "
  ...
  AddDetail(({"pasarela"}),
     ...
     "planta del castillo al norte de aqui.\n");
  ...
  AddExit("norte",Z_CASTILLO("patio/patio13"));
  AddExit("sur",Z_CASTILLO("patio/patio15"));
}
