...
FICHERO      : /d/akallab/comun/habitacion/akallab/zarkam/camino/cc_09.c
MODIFICACION : 23-02-98 [Angor@Simauria] Creacion.
...
create() {
  ...
  SetIntLong(
     "Te encuentras en el Sendero de los Cráneos, justo al norte de la ciudad de "
     "Zarkam. El camino continua ascendiendo lentamente hacia la loma en la que se "
     "halla esta ciudad fortificada. Observas como la puerta esta custodiada por "
     "varios guardias que controlan a la gente que entra y sale. Los guardias van "
     "bien armados y no parecen muy amistosos. El viento sopla con fuerza.\n");

  AddDetail(({"puerta"}),"La puerta sur de la ciudad de Zarkam queda al norte de aqui.\n");

  AddDetail(({"guardia","guardias","soldados"}),
     "Desde aqui puedes observar la entrada norte de la ciudad. En ella una guarnicion "
