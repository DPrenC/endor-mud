...
FICHERO      : /d/akallab/comun/habitacion/akallab/zarkam/cementerio/tumba09.c
...
create() {
  ...
  AddExit("norte",Z_CEMENTERIO("tumba10"));
  AddExit("este",Z_CEMENTERIO("tumba06"));
  AddExit("abajo",Z_CEMENTERIO("fosa09"));
}
