...
FICHERO      : /d/akallab/comun/habitacion/akallab/zarkam/c_camp06.c
...
protected void updateDescr()
{
 SetIntLong(
   ...
   mirar_trigo()+
   "Te encuentras en el camino que atraviesa estos campos. Al sudeste de aqui un "
   "viejo puente de madera permite cruzar sobre el río Kusaii. Al norte de los "
   "campos observas la cabanya destinada a los esclavos que trabajan en ellos.\n");
}
...
create() {
 ...
 AddDetail(({"tierras de cultivo","cultivos","campos de cultivo"}),
  ...
  AddExit("norte",Z_CAMPOS("campo_01"));
  AddExit("nordeste",Z_CAMPOS("huerta_03"));
  AddExit("sudeste",Z_CAMPOS("c_camp05"));
  AddExit("oeste",Z_CAMPOS("c_camp08"));
  AddExit("suroeste",Z_CAMPOS("huerta_02"));
}
