...
FICHERO     : /d/akallab/comun/habitacion/akallab/zarkam/castillo/patio/patio13.c
...
create() {
 ...
 SetIntLong(
     ...
     "muralla con el primer piso del castillo. Al oeste se encuentra una de las torres "
  ...
  AddExit("oeste",Z_CASTILLO("muralla/torre25"));
  AddExit("norte",Z_CASTILLO("patio/patio12"));
  AddExit("sur",Z_CASTILLO("patio/patio14"));
}
