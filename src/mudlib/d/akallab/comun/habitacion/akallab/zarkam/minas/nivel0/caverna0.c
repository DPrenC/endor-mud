...
FICHERO      : /d/akallab/comun/habitacion/akallab/zarkam/mina/nivel0/caverna0.c
...
create() {
  ...
  SetIntLong(
  "Justo al oeste de aqui comienza una de las galerias que parten de esta "
  ...
  AddExit("este",Z_MINAS("/nivel0/caverna1"));
  AddExit("sur",Z_MINAS("/nivel0/caverna3"));
  AddExit("oeste",Z_MINAS("/nivel0/galer03"));
}
