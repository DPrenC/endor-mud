...
FICHERO      : /d/akallab/comun/habitacion/akallab/kuntz/cueva/suelo2.c
...
create() {
 ...
 AddExit("este",K_CUEVA("suelo03"));
 AddExit("norte",K_CUEVA("suelo00"));
 AddExit("sur",K_CUEVA("caverna11"));
 AddExit("oeste",K_CUEVA("caverna12"));
}
