...
FICHERO      : /d/akallab/comun/rooms/akallab/kuntz/cuevas/cueva04.c
...
create() {
  ...
  SetIntLong(
      "Te encuentras en el extremo de una galeria subterranea. Al este de aqui se abre "
      ...
      "pequenya isla con un monolito. Una galeria parte de aqui hacia el oeste. Oyes "
      "voces que vienen de alli.\n");
 ...
 AddExit("este",K_CUEVA("monolito"));
 AddExit("sudeste",K_CUEVA("cueva03"));
 AddExit("nordeste",K_CUEVA("cueva02"));
 AddExit("oeste",K_CUEVA("galeria00"));
}
