...
FICHERO     : /d/akallab/comun/habitacion/akallab/kuntz/tienda/armeria1.c
...
create(){
 ...
 AddExit("oeste",K_CUEVA("caverna09"));
 ...
 SetShopkeeper(0,([P_SHORT:"Kull el troll",
P_LONG:  "Kull es un troll adulto. Cojea de la pierna derecha, probablemente "
...
AddArticle(ARMA("azagaya"), REFRESH_REMOVE, 2);
...
{
  (::init());
  write("Kull te saluda con un grunyido al entrar en la cueva.\n");
  say(  "Kull saluda con un grunyido a "+NOMBRE+" al entrar a la cueva.\n");
}
