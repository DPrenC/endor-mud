...
FICHERO      : /d/akallab/comun/rooms/akallab/kuntz/cuevas/galeria04.c
...
create() {
  ...
  "Estas en una galleria subterranea que avanza por las estranyas de esta "
	...
	"las grietas del techo. Al nordeste de aqui se abre lo que parece ser "
	"una gran caverna de la cual provienen voces.\n");

  AddDetail(({"caverna"}), "Queda al nordeste. Desde aqui no puedes ver gran cosa\n");
 ...
 AddExit("suroeste",K_CUEVA("galeria25"));
