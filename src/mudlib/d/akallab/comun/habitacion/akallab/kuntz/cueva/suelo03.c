...
FICHERO      : /d/akallab/comun/habitacion/akallab/kuntz/cueva/suelo3.c
...
create() {
 ...
 AddExit("oeste",K_CUEVA("suelo02"));
 AddExit("norte",K_CUEVA("suelo01"));
 AddExit("este",K_CUEVA("caverna09"));
 AddExit("sur",K_CUEVA("caverna10"));
}
