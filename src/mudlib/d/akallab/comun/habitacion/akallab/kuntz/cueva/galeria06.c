...
FICHERO      : /d/akallab/comun/rooms/akallab/kuntz/cuevas/galeria06.c
...
create() {
  ...
  "Estas en una galleria subterranea que avanza por las estranyas de esta "
	...
	"las grietas del techo. Al noroeste de aqui se abre lo que parece ser "
	"una gran caverna de la cual provienen voces.\n");

  AddDetail(({"caverna"}), "Queda al noroeste. Desde aqui no puedes ver gran cosa\n");
 ...
 SetIntNoise("Oyes el goteo del agua y voces al noroeste.\n");
 ...
 AddExit("noroeste",K_CUEVA("caverna10"));
