...
FICHERO      : /d/akallab/comun/rooms/akallab/kuntz/cuevas/galeria08.c
...
create() {
  ...
  "Estas en una galleria subterranea que avanza por las estranyas de esta "
	...
	"las grietas del techo. Al oeste de aqui se abre lo que parece ser "
 ...
 AddExit("oeste",K_CUEVA("caverna17"));
