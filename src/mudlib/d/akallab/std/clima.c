/*
 * Servidor de clima estándar.
 * Hecho por Nemesis (Noviembre de 1997).
 * Basado en: Woodland Weather Server [July '94 by Joern]
 * Modificacion:
 *   1-Dic-98 Creo que al fin los estados iran bien. 21600/24 da 900 segundos
 *            como duracion de una hora del mud, no 750 que es lo que yo calcule
 *            a ojo sin pensar en nada :)
 *   4-10-99 [Theuzifan] Heredo el servidor de climas por defecto y cambio
 *		los mensajes estándares de éste por los que se curró Nemesis.
 *  21-11-04 [Greywolf] Cojo el servidor de Nemesis y lo aplico al resto de dominios
*/
...
helado.\n",                                                        /* 1 */
 ...
 "Ya no graniza, pero el viento es aun muy fuerte.\n",            /* 10 */
 "El cielo se aclara y puedes ver algunas estrellas. Solo sopla una brisa\n\
fresca.\n"
 }));
