/* Guardias de Kha-annu.
   ...
   Gorthem@Simauria 9-nov-98
      Poniendo el set locate pa que no se vayan en un viaje del inserso.
             ( A kentor)
   [Woo] Modificado
   [Nemesis] Insertadas las obs de forma correcta.
*/
#include "path.h"
#include <guild.h>
#include <moving.h>
...
"No parece tener ningún rango.\n");
    ...
    SetGoChance(10);
    SetWhimpy(0);
    AddQuestion(({"seguridad","ciudad","preocupacion","preocupación"}),
