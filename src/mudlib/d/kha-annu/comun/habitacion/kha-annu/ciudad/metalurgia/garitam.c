...
create() {
 ...
 SetIntShort("la Garita de Seguridad de Metalurgia");

 SetIntLong(
"Entras en la garita de seguridad de la Escuela de Metalurgia. Es una habitacion "
...
"Hay un cartel encima de la garita. Unas antorchas iluminan el sitio.\n");
 ...
 AddItem(MONS+"lophekz",REFRESH_DESTRUCT,1);

 SetLocate("metalurgia");
}
