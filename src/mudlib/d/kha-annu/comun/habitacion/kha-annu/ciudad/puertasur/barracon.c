...
create() {
 ...
 SetIntShort("el barrracón de la puerta sur de Kha-annu");
 SetIntLong("Entras al barracon de la puertas sur, de Kha-annu, "
 ...
 "normal. Las paredes estan llenas de grabados y hay un par de faroles que.\n"
 "las iluminan.\n");
 SetIndoors(1);
 SetIntBright(50);
 SetIntNoise("No oyes nada fuera de lo normal.\n");
 SetIntSmell("Huele a sudor y a cerrado.\n");
 SetLocate("Kha-annu");
