...
{
    ::create();
    SetIntShort("la habitación normal, en la posada del Dragón Azul");
    SetIntLong("Te encuentras en la habitación normal. Tiene una cama con sábanas limpias. "
    ...
    AddDetail(({"alfombra","gran alfombra"}),"Es de color rojo y cubre todo el suelo de la "
        "habitación.\n");
    AddDetail(({"cama"}),"Una cama preparada, con sábanas limpias en la que puedes dormir.\n");
