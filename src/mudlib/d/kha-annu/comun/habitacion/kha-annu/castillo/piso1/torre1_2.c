...
create() {
   ::create();
SetIntShort("un puesto de vigilancia en la Torre del Nordeste");

SetIntLong(
"Has subido hasta el puesto de vigilancia de la Torre del Nordeste del "
