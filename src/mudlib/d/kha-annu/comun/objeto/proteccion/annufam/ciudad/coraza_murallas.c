...
{
    ::create();
    SetStandard(AT_CORAZA,14,P_SIZE_NORMAL,M_ACERO);
    ...
    AddSubDetail(({"cabeza","cabeza de leon","cabeza del leon","cabeza de un "
                 "león","cabeza de un leon","leon","león"}),W("A la altura del"
                   " corazón del casco puedes ver grabada la cabeza de un "
                   "león.\n"));
}
