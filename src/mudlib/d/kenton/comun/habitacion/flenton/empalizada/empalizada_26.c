...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El sendero que separa "
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_27");
  AddExit("oeste",FLENHAB+"empalizada/empalizada_25");
  switch(random(4))
  {
