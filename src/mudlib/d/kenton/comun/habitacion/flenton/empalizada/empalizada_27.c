...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El bosque es menos "
  	"denso aquí.\n");
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_28");
  AddExit("oeste",FLENHAB+"empalizada/empalizada_26");
}