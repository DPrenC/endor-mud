...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El bosque se extiende "
  	"hasta donde te alcanza la vista. Al norte hay un pequeño sendero "
  	"entre unos arbustos.\n");
  ...
  AddExit("norte",FLENHAB+"pantano/lago");
  AddExit("oeste",FLENHAB+"empalizada/empalizada_19");
  AddExit("sudeste",FLENHAB+"empalizada/empalizada_21");
  switch(random(4))
  {
