...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El bosque continúa "
  	"hacia el sur.\n");
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_03");
  AddExit("suroeste",FLENHAB+"empalizada/empalizada_05");
}