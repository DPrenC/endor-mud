...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. La entrada del poblado "
  	"se encuentra al sur.\n");
  ...
  AddExit("norte",FLENHAB+"empalizada/empalizada_29");
  AddExit("sur",FLENHAB+"calles/entrada");
  switch(random(4))
  {
