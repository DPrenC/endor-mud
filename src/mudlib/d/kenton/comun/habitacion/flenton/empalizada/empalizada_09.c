...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. Al sur continúa el "
  	"espeso bosque que rodea al poblado.\n");
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_08");
  AddExit("oeste",FLENHAB+"empalizada/empalizada_10");
  switch(random(4))
  {
