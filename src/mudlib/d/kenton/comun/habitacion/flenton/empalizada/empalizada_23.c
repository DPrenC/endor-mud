...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El sendero continúa "
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_24");
  AddExit("oeste",FLENHAB+"empalizada/empalizada_22");
  switch(random(4))
  {
