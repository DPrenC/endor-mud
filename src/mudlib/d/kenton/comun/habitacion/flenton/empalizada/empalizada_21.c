...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El sendero gira en "
  	"esta parte.\n");
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_22");
  AddExit("noroeste",FLENHAB+"empalizada/empalizada_20");
}