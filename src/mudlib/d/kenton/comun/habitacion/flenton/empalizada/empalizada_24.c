...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El sendero es algo "
  	"más estrecho en esta parte.\n");
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_25");
  AddExit("oeste",FLENHAB+"empalizada/empalizada_23");
}