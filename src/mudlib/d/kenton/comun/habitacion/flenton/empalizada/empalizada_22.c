...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. El bosque es algo "
  	"más denso en esta parte.\n");
  ...
  AddExit("este",FLENHAB+"empalizada/empalizada_23");
  AddExit("oeste",FLENHAB+"empalizada/empalizada_21");
  switch(random(4))
  {
