...
create() {
  ...
  SetIntLong("Estás en las afueras del poblado de Flenton. Ves la alta "
  	...
  	"árbol que sobresale en el centro del mismo. Hay un frondoso "
  ...
  AddExit("oeste",FLENHAB+"empalizada/empalizada_27");
  AddExit("sudeste",FLENHAB+"empalizada/empalizada_29");
  switch(random(4))
  {
