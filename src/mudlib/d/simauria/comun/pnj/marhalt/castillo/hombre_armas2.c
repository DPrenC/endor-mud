/****************************************************************************
Fichero: hombre_armas2.c
Autor: Ratwor
Fecha: 03/12/2007
Descripción: un guardia para la casa de tributos de Nandor.
****************************************************************************/
#include "./path.h"
...
create(){
    ...
    AddId(({"Hombre de armas", "guardia", "humano", "hombre"}));
    SetAlign(80);
    SetWhimpy(20);
    InitChats(3, ({"El hombre de armas te mira de arriba a abajo.\n",
        ...
        "El hombre de armas te pregunta: ¿Vienes a pagar los tributos a mi señor?\n"}));
    InitAChats(12, ({"El hombre de armas grita: ¡A las armas!\n",
