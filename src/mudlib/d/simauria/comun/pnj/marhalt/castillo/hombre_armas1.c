/****************************************************************************
Fichero: hombre_armas1.c
Autor: Ratwor
Fecha: 03/12/2007
Descripción: un guardia para el castillo, que se moverá por todo el dominio de su señor.
****************************************************************************/
#include "./path.h"
...
create(){
    "*"::create();
    SetStandard("un hombre de armas", "humano", ([GC_LUCHADOR:26+d10()]),  GENDER_MALE);
    ...
    InitChats(3, ({"El hombre de armas te mira de arriba a abajo.\n",
        "El hombre de armas se urga distraídamente la nariz y pega su hallazgo en una de sus botas.\n",
        "El hombre de armas se aparta un poco el casco y se rasca la sucia cabeza.\n",
        "El guardia dice: en cuanto me releven acudiré a tomar unas cervezas en la posada "
        ...
        "El guardia mira a su alrededor espectante.\n",
        "El guardia te pregunta: ¿Dando una vueltecita por los dominios de mi señor?\n"}));
    InitAChats(14, ({"El hombre de armas grita: ¡A las armas!\n",
    ...
    SetIVision(0);
    SetGoChance(100);
    AddWalkZones(({MARH("nandor"), CAMINOS "/norte_marhalt"}));
    switch(d3())
    {
        case 1:
