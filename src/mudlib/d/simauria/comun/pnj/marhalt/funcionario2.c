...
create() {
    ...
    "El hombre dice: 'Aquí puedes cuñar el impreso para obtener el JK23-H.'\n");
    AddQuestion(({"cuñar","cunyar","ayuda"}),
    "El funcionario te dice cansinamente: 'Para cuñar el impreso escribe 'cuñar'.\n");
}
