/*********************************************************/
//		"orco"
//	El típico orco perteneciente a un clan nómada.
...
"tintes verdosos. Un par de largos colmillos adornan su gran mandíbula."
" Lleva el símbolo de su clan tatuado en la frente, y los brazos tatuados"
" en color " + color +".\n"));
SetIds(({"orco"}));
SetAggressive(1);
