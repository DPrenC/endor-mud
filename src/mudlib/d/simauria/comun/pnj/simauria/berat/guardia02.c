...
Autor: Dharkus
Fecha: 04/05/2010
Descripción: Un guardia para la sala de descanso del cuartel de Berat
****************************************************************************/
...
create() {
    ...
    switch(d3()){
        ...
        case 2:
            ...
            "como descendiente de los Berati, pueblo que habitó en el delta del Raxal "
            "antes de que los Ishtrios vinieran del mar y que con la ayuda de éstos, "
            "edificaran el puerto de Berat en la parte occidental del delta.\n");
            break;
        case 3:
   ...
   "formado por los más audaces y avezados habitantes oriundos de este puerto, que "
    ...
    InitChats(2,({
    "El soldado dice: ¡Qué paz y tranquilidad!\n",
    "El guardia dice: Todavía queda un ratito para retomar mi turno.\n",
    "El guardia parece amuermado.\n",
    "El guardia se recuesta en un cojín.\n"}));
