...
DESCRIPCION : humana
FICHERO     : mjc2.c
MODIFICACION: 08-08-01 [Tirdos] (basado en mujerkender)
*/
...
"sino darte cuenta que es una buena luchadora que no teme enfrentarse a ningún adversario.\n"));
   SetRace("humana");
   SetGender (1);
   SetAggressive(0);
   x=random(23)+10;
...
"La muchacha grita: Fuera de mi casa!!!\n",
   ...
   InitAChats(10, ({
"la mujer grita: AYUDA!! AYUDA!! me atacan!!!",
                 }) );
