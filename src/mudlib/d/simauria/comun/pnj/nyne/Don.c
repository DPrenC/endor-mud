...
create() {
    ::create();
    SetStandard("Don","humano",([GC_LUCHADOR: 20]),GENERO_MASCULINO);
    SetShort("Don, el tendero");
    SetLong("Don es un humano común. Va vestido con ropas oscuras, y lleva un extraño "
