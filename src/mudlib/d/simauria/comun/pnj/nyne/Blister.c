...
create() {
    ::create();
    SetStandard("Blister","humano",([GC_LUCHADOR: 20]),GENERO_MASCULINO);
    SetShort("Blister, el tendero");
    SetLong("Blister es un humano común. Va vestido con ropas oscuras, y lleva un extraño "
