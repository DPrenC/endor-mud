...
create() {
    ::create();
    SetStandard("Vix","humano",([GC_LUCHADOR: 20]),GENERO_MASCULINO);
    SetShort("Vix, el tendero");
    SetLong("Vix es un humano común. Va vestido con ropas oscuras, y lleva un extraño "
