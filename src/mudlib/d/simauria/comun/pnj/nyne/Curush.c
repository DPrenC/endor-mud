...
create() {
    ::create();
    SetStandard("Curush","humano",([GC_LUCHADOR: 20]),GENERO_MASCULINO);
    SetShort("Curush, el tendero");
    SetLong("Curush es un humano común. Va vestido con ropas oscuras, y lleva un extraño "
