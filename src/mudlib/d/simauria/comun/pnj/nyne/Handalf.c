...
create() {
    ::create();
    SetStandard("Handalf","humano",([GC_LUCHADOR: 20]),GENERO_MASCULINO);
    SetShort("Handalf, el tendero");
    SetLong("Handalf es un humano común. Va vestido con ropas oscuras, y lleva un extraño "
