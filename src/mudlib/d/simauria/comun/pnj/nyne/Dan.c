...
create() {
    ::create();
    SetStandard("Dan","humano",([GC_LUCHADOR: 20]),GENERO_MASCULINO);
    SetShort("Dan, el tendero");
    SetLong("Dan es un humano común. Va vestido con ropas oscuras, y lleva un extraño "
