...
AddDetail(({"paja","monton de paja","monton paja","montón paja","montón de "
"paja"}),W("Es un montón de paja amontonado en una esquina. El hecho de que "
"esté cubierto por una raída y amarillenta sábana te hace pensar que se hacía "
...
AddExit("norte","pasi05");
AddItem(PNJGD("aranya"),REFRESH_ALWAYS);
AddItem(PNJGD("rata"),REFRESH_ALWAYS,2);
}