...
create()
{
    ...
    SetIntLong("Estás en la falda de una fría montaña, sobre un camino de tierra húmeda "
        "rodeado a los lados por altos pinos. El camino asciende hacia el este y desciende "
        "hacia el suroeste uniendo el bosque de Nandor con la vieja torre de Gundistyr. Hacia "
    ...
    AddItem(PNJGD("histori"),REFRESH_DESTRUCT,1);
    AddExit("suroeste","camino01");
