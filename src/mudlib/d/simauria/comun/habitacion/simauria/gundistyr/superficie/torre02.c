...
"de los años y las inclemencias del tiempo la han dejado en el estado actual."
"\n"));
AddDetail(({"restos"}),"Ves restos de muros por todas partes.\n");
AddDetail(({"rocas","monton de roca", "montónes de roca","montón "
"roca","monton roca"}),W("Hay un montón de rocas provenientes de una antigua "
"pared.\n"));
