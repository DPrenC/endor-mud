...
AddExit("este","3sotano07");
AddExit("sur","3sotano10");
AddExit("oeste","3sotano05");
AddExit("suroeste","3sotano09");
AddExit("sudeste","3sotano11");

AddItem(PNJGD("kobduerme"),REFRESH_REMOVE,random(2));
}
