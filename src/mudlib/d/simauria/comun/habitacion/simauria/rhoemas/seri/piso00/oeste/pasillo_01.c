...
create () {
  ...
  AddExit("norte",RHOEHAB("seri/piso00/oeste/habitacion_04"));
  AddExit("este",RHOEHAB("seri/piso00/oeste/pasillo_00"));
  AddExit("oeste",RHOEHAB("seri/piso00/oeste/pasillo_02"));
