/***************************************************************************************
 ARCHIVO:	arrozal_04.c
 AUTOR:		[z] Zomax
 FECHA:		02-11-2001
 COMENTARIOS:	Arrozal nº 04, en Koek.
 ***************************************************************************************/
...
create () {
 ...
 AddExit("oeste",RHOEHAB("koek/campos/arrozal_03"));
 AddExit("noroeste",RHOEHAB("koek/campos/arrozal_01"));
 /******************************  INVIERNO ******************************/
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W(
 	...
 	"El helado río Hedrikon baña las tierras del lugar por todas partes "+
 	"menos por el oeste, haciéndolas muy buenas para el cultivo.\n"));
 	AddDetail(({"nieve"}),W(
 	...
 	"El río discurre casi rodeando el arrozal, aunque ahora no es más que una gran "+
 	"capa de hielo.\n"));
 	SetIntSmell(W(
 ...
 if (CHRONOS->QueryEstacion()==2)
 {
 	...
 	"por las aguas del río Hedrikon, que discurre rodeando el campo salvo "+
 	"por el oeste, y no llegas a distinguir nada más que agua por todas "+
 	"partes salvo unos pequeños brotes verdes que sobresalen.\n"));
 	AddDetail(({"nieve"}),W(
 	...
 	"con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 	"El río Hedrikon, que discurre rodeando el campo salvo por el oeste, está "+
 	"ahora muy crecido por el deshielo, inundando el arrozal.\n"));
 ...
 if (CHRONOS->QueryEstacion()==3)
 {
 	...
 	"ya crecido y dispuesto para que los agricultores lo recojan. Por "+
 	"el norte, este y sur puedes ver el río Hedrikon, ya más calmado "+
 	"después de los deshielos de la primavera.\n"));
 	AddDetail(({"tierra","suelo"}),W(
 	"La tierra de esta zona es algo rojiza y muy fértil gracias a su proximidad "+
 	"con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 	"Al río discurre por todas partes salvo el oeste, ahora más tranquilo, "+
 	"después de los deshielos y el calor del verano.\n"));
 ...
 if (CHRONOS->QueryEstacion()==4)
 {
 	...
 	"con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 	"Observas el río Hedrikon, al norte, este y sur, que proporciona gran riqueza a las "+
 	"tierras del lugar.\n"));
