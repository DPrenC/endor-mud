/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		17-12-2001
 COMENTARIOS:	Tramo 01 del puente que lleva a los cultivos, en Koek
 ***************************************************************************************/
...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/campos/puente_00"));
 AddExit("sur",RHOEHAB("koek/campos/puente_02"));
 ...
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W("Estás en el centro del puente que lleva a los campos "
