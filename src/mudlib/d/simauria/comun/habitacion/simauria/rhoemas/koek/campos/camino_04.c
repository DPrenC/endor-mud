...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/campos/camino_01"));
 AddExit("este",RHOEHAB("koek/campos/camino_05"));
 AddExit("oeste",RHOEHAB("koek/campos/camino_03"));
 ...
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de "
 		...
 		"por unas huellas en la nieve. Hacia el norte el camino lleva "
 		"a Koek, y hacia los lados sigue hasta los campos.\n"));
 	...
 	AddDetail(({"campo","campos"}),W("Desde aquí no los distingues bien, "
 		"deberías seguir el camino.\n"));
 ...
 if (CHRONOS->QueryEstacion()==2)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de cultivos "
 		...
 		"toque de colorido al camino. Hacia el norte el camino lleva a "
 		"Koek, y hacia el este y oeste hacia los campos.\n"));
 ...
 if (CHRONOS->QueryEstacion()==3)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de cultivos "
 		...
 		"colorido. Hacia el norte el camino sigue hasta Koek, y a los lados "
 		"hasta los campos.\n"));
 ...
 if (CHRONOS->QueryEstacion()==4)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de cultivos "
 		"de Koek, al sur del pueblo. Es un camino de tierra rojiza con "
 		"varias hierbas a los lados del camino que dan un toque de "
 		"colorido. Si sigues el camino hacia el norte llegarás a Koek, "
 		"y por el este y el oeste hasta los campos.\n"));
 	AddDetail(({"tierra","suelo"}),W("La tierra de esta zona es algo "
