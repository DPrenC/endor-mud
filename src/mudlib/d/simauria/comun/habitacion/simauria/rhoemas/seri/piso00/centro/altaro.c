...
create () {
  ...
  SetIntLong(W("Estás en una pequeña habitación muy adornada llena de tapices y alfombras "
  	...
  	"Hay una gran losa de mármol negro con un pequeño hueco en el centro donde se "
  ...
  AddDetail(({"losa","marmol","mármol","hueco"}),W("Una enorme y pesada losa de mármol "
  	"negro en el centro de la habitación. Justo en el mismo centro de la losa "
  ...
  AddExit("este",RHOEHAB("seri/piso00/centro/pasillo_03")); 
}
