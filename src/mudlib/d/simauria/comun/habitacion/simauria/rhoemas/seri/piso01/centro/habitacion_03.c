/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		13-01-2002
 COMENTARIOS:	Habitación central 05
 ***************************************************************************************/
...
create () {
  ...
  SetIntLong(W("Estás en la habitación de uno de los discípulos. Hay una vieja cama "
  ...
  AddExit("oeste",RHOEHAB("seri/piso01/centro/pasillo_03"));
