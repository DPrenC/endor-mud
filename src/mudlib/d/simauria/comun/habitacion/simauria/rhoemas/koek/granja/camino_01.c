...
create () {
 ...
 carcel=(RHOEHAB("koek/granja/camino_02"));
 ...
 AddExit("norte",RHOEHAB("koek/granja/camino_00"));
 AddExit("sur",RHOEHAB("koek/granja/camino_02"));
 AddExit("este",RHOEHAB("koek/granja/piara"));
 AddExit("oeste",RHOEHAB("koek/granja/vaqueria"));
 AddDetail(({"camino"}),SF(fcamino));
 SetIntLong(W("Te encuentras en un camino en la granja de Koek. Al norte "
 	"el camino sigue hacia la casa del granjero y al sur hasta la calle "
 	"Folker. Al este puedes ver la piara y al oeste la vaquería. Parece "
 	"que por aquí no suele pasar mucha gente.\n"));
 /******************************  INVIERNO ******************************/
 if (CHRONOS->QueryEstacion()==1)
 {
