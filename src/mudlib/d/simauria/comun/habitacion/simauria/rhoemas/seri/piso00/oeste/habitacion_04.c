/***************************************************************************************
 ARCHIVO:	habitacion_04.c
 AUTOR:		[z] Zomax
 FECHA:		04-01-2002
 COMENTARIOS:	Habitación oeste 04
 ***************************************************************************************/
...
create () {
  ...
  SetIntLong(W("Estás en los aposentos de uno de los aprendices. Puedes ver "
  	"que en esta habitación los detalles están algo más cuidados, siempre "
  	"dentro de la austeridad predominante de los aprendices. Hay unos bonitos "
  ...
  AddExit("sur",RHOEHAB("seri/piso00/oeste/pasillo_01"));
