...
create () {
  ...
  AddExit("norte",RHOEHAB("seri/piso01/oeste/pasillo_09"));
  AddExit("sur",RHOEHAB("seri/piso01/oeste/pasillo_07"));
  AddExit("este",RHOEHAB("seri/piso01/oeste/habitacion_00"));
