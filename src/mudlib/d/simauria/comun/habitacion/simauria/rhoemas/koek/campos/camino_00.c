...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/campos/puente_02"));
 AddExit("sur",RHOEHAB("koek/campos/camino_01"));
 AddDetail(({"camino"}),SF(fcamino));
 AddDetail(({"puente"}),W("Al norte ves el puente que cruza el río Hedrikon. "
 	"Es un puente de piedra muy robusto.\n"));
 	/******************************  INVIERNO ******************************/
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de "
 		...
 		"por unas huellas en la nieve. Al norte puedes ver el "
 		"puente que cruza el río Hedrikon, que está helado por "
 		"completo, y al sur sigue el camino. Hacia los lados puedes "
 	...
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"Desde aquí divisas el río, al norte, cruzado por el puente. "
 		"Ahora está completamente helado en la superficie.\n"));
 	AddDetail(({"huella","huellas"}),W("Hay varias huellas en la nieve. "
 		"De personas, animales...\n"));
 	AddDetail(({"campo","campos"}),W("Al este y al oeste ves campos "
 ...
 if (CHRONOS->QueryEstacion()==2)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de cultivos "
 		...
 		"toque de colorido al camino. Al norte puedes ver el puente que "
 		"cruza el río Hedrikon, muy crecido gracias al deshielo, y al "
 		"sur sigue el camino. Hacia los lados puedes ver campos que "
 	...
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"El río Hedrikon discurre por el norte bajo el puente. Ahora "
 		"lleva mucha agua, gracias al deshielo.\n"));
 	AddDetail(({"hierba","hierbas","pequeña hierba","pequeñas hierbas"}),W(
 		"Algunas hierbas salvajes crecen a los lados del camino.\n"));
 	AddDetail(({"campo","campos"}),W(
 		"Al este y al oeste ves campos renaciendo tras el duro invierno.\n"));
 ...
 if (CHRONOS->QueryEstacion()==3)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de cultivos "
 		...
 		"colorido. Al norte puedes ver el puente que cruza el río "
 		"Hedrikon, y al sur sigue el camino. Hacia los lados puedes "
 		"ver campos llenos de todo tipo de cultivos.\n"));
 	AddDetail(({"tierra","suelo"}),W("La tierra de esta zona es algo rojiza "
 		"y muy fértil gracias a su proximidad con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"El río Hedrikon discurre por el norte bajo el puente.\n"));
 	AddDetail(({"hierba","hierbas","pequeña hierba","pequeñas hierbas"}),W(
 		"Algunas hierbas salvajes crecen a los lados del camino.\n"));
 	AddDetail(({"campo","campos","cultivo","cultivos"}),W("Al este y al "
 		"oeste ves campos llenos de todo tipo de cultivos.\n"));
 	SetIntSmell("El olor a tierra mojada invade el ambiente.\n");
 ...
 if (CHRONOS->QueryEstacion()==4)
 {
 	...
 	AddDetail(({"campo","campos","cultivo","cultivos","campo de cultivo","campos de cultivo"}),W(
 		"Al este y al oeste ves campos llenos de todo tipo de cultivos.\n"));
 	SetIntSmell("El olor a tierra mojada invade el ambiente.\n");
