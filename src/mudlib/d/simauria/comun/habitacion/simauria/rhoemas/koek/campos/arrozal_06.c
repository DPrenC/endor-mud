/***************************************************************************************
 ARCHIVO:	arrozal_06.c
 AUTOR:		[z] Zomax
 FECHA:		02-11-2001
 COMENTARIOS:	Arrozal nº 06, en Koek.
 ***************************************************************************************/
...
int fcoger(string str)
{
	...
	if (CHRONOS->QueryEstacion()==4)
	{
		...
		{
			write(W("Mejor no coger los, no sirven para nada y puede "+
...
create () {
 ...
 AddExit("sur",RHOEHAB("koek/campos/arrozal_09"));
 AddExit("este",RHOEHAB("koek/campos/arrozal_07"));
 AddExit("oeste",RHOEHAB("koek/campos/arrozal_05"));
 ...
 if (CHRONOS->QueryEstacion()==1)
 {
 	...
 	"Al norte está el helado río Hedrikon, que baña las tierras del lugar "+
 	"haciéndolas muy buenas para el cultivo.\n"));
 	AddDetail(({"nieve"}),W(
 	...
 	"El río discurre por el norte, aunque ahora no es más que una gran "+
 	"capa de hielo.\n"));
 	SetIntSmell(W(
 ...
 if (CHRONOS->QueryEstacion()==2)
 {
 	...
 	"por las aguas del río Hedrikon, que discurre por el norte, y no "+
 	...
 	"con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 	"El río Hedrikon, que discurre por el norte, está ahora muy crecido por "+
 ...
 if (CHRONOS->QueryEstacion()==3)
 {
 	...
 	"norte puedes ver el río Hedrikon, ya más calmado después de "+
 	"los deshielos de la primavera.\n"));
 	AddDetail(({"tierra","suelo"}),W(
 	"La tierra de esta zona es algo rojiza y muy fértil gracias a su proximidad "+
 	"con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 	"Al río discurre por el norte, ahora más tranquilo, después de los "+
 ...
 if (CHRONOS->QueryEstacion()==4)
 {
 	...
 	"con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 	"Observas el río Hedrikon, al norte, que proporciona gran riqueza a las "+
 	"tierras del lugar.\n"));
