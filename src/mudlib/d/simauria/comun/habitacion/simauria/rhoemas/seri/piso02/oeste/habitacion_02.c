/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		13-01-2002
 COMENTARIOS:	Habitación oeste 02
 ***************************************************************************************/
...
create () {
  ...
  SetIntLong(W("Estás en una habitación muy simple, prácticamente cuatro paredes "
  	...
  	"carcomida. En otra pared ves un gran espejo colgado. Parece que el maestro "
  	"que la habita es de la vieja escuela.\n"));
  ...
  espejo=1;
  AddExit("oeste",RHOEHAB("seri/piso02/oeste/pasillo_07"));
