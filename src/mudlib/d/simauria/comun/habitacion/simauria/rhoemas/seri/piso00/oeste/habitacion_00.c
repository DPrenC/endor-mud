/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		28-12-2001
 COMENTARIOS:	Habitación oeste 00
 ***************************************************************************************/
...
string fmesa()
{
	 if (llave) return W("Al lado de la cama hay una pequeña mesa para dejar "
  			"encima enseres personales. Puedes ver una llave encima.\n");
  	else return W("Al lado de la cama hay una pequeña mesa para dejar "
