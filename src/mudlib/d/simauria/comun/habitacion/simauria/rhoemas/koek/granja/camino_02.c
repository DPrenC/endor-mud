...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/granja/camino_01"));
 AddExit("sur",RHOEHAB("koek/calles/folker_01"));
 AddDetail(({"camino"}),SF(fcamino));
 SetIntLong(W("Te encuentras en un camino en la granja de Koek. Es un camino "
 	"algo arenoso pero en buen estado. Si sigues hacia el norte llegarás "
 	"a la granja, y si vas al sur a la calle Folker y más aún a los campos "
 	"de cultivo, pasando el puente.\n"));
 /******************************  INVIERNO ******************************/
 if (CHRONOS->QueryEstacion()==1)
 {
