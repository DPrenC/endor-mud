/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		01-11-2001
 COMENTARIOS:	Viñedo nº 02, en Koek.
 ***************************************************************************************/
...
create () {
 ...
 AddExit("sur",RHOEHAB("koek/campos/vinyedo_05"));
 AddExit("oeste",RHOEHAB("koek/campos/vinyedo_01"));
 /******************************  INVIERNO ******************************/
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W("Estás en uno de los viñedos de Koek, a las afueras "
 		...
 		"la nieve, en la primavera volverá ha resurgir todo. Al "
 	...
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"El río discurre por el norte, aunque ahora no es más que "
 ...
 if (CHRONOS->QueryEstacion()==2)
 {
 	SetIntLong(W("Estás en uno de los viñedos de Koek, a las afueras "
 		...
 		"auguran una muy buena cosecha para el otoño. Al norte ves "
 	...
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"El río Hedrikon, que discurre por el norte, está ahora muy "
 ...
 if (CHRONOS->QueryEstacion()==3)
 {
 	SetIntLong(W("Estás en uno de los viñedos de Koek, a las afueras del "
 		...
 		"otoño. Por el norte discurre el río Hedrikon.\n"));
 	...
 	AddDetail(({"tierra","suelo"}),W("La tierra de esta zona es algo "
 		"rojiza y muy fértil gracias a su proximidad con el río Hedrikon.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"Al río discurre por el norte, ahora más tranquilo, después "
 ...
 if (CHRONOS->QueryEstacion()==4)
 {
 	SetIntLong(W("Estás en uno de los viñedos de Koek, a las afueras "
 		...
 		"últimos días. Ves el río hacia el norte.\n"));
