/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		04-01-2002
 COMENTARIOS:	Habitación oeste 01
 ***************************************************************************************/
...
string fmirar()
{
	...
	else if (dinero) return "Parece que hay algo de dinero dentro del arcón.\n";
...
create () {
  ...
  dinero=1;
  AddExit("norte",RHOEHAB("seri/piso00/oeste/pasillo_08"));
...
{
	if(str=="dinero" || str=="dinero de arcon" || str=="dinero de arcon")
	{
		if (dinero && arcon)
		{
