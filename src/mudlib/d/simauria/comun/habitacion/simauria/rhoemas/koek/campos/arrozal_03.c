/***************************************************************************************
 ARCHIVO:	arrozal_03.c
 AUTOR:		[z] Zomax
 FECHA:		02-11-2001
 COMENTARIOS:	Arrozal nº 03, en Koek.
 ***************************************************************************************/
...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/campos/arrozal_01"));
 AddExit("sur",RHOEHAB("koek/campos/camino_09"));
 AddExit("este",RHOEHAB("koek/campos/arrozal_04"));
 AddExit("oeste",RHOEHAB("koek/campos/arrozal_02"));
 ...
 if (CHRONOS->QueryEstacion()==2)
 {
 	...
 	"por las aguas del río Hedrikon, que discurre muy por el norte, y no "+
 	...
 	AddDetail(({"tierra","suelo"}),W(
 	"La tierra de esta zona es algo rojiza y muy fértil.\n"));
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 	"El río Hedrikon, que discurre más hacia el norte, está ahora muy crecido por "+
 ...
 if (CHRONOS->QueryEstacion()==3)
 {
 	...
 	"ya crecido y dispuesto para que los agricultores lo recojan.\n"));
 	AddDetail(({"tierra","suelo"}),W(
 	"La tierra de esta zona es algo rojiza y muy fértil.\n"));
