/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		01-11-2001
 COMENTARIOS:	Viñedo nº 04, en Koek.
 ***************************************************************************************/
...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/campos/vinyedo_01"));
 AddExit("sur",RHOEHAB("koek/campos/camino_02"));
 AddExit("este",RHOEHAB("koek/campos/vinyedo_05"));
 AddExit("oeste",RHOEHAB("koek/campos/vinyedo_03"));
 /******************************  INVIERNO ******************************/
 if (CHRONOS->QueryEstacion()==1)
 {
