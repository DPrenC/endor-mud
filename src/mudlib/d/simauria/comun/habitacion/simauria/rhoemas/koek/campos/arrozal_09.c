/***************************************************************************************
 ARCHIVO:	arrozal_09.c
 AUTOR:		[z] Zomax
 FECHA:		02-11-2001
 COMENTARIOS:	Arrozal nº 09, en Koek.
 ***************************************************************************************/
...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/campos/arrozal_06"));
 AddExit("sur",RHOEHAB("koek/campos/camino_06"));
 AddExit("este",RHOEHAB("koek/campos/arrozal_10"));
 AddExit("oeste",RHOEHAB("koek/campos/arrozal_08"));
 /******************************  INVIERNO ******************************/
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W(
