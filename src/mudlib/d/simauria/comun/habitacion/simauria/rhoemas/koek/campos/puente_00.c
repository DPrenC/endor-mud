/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		17-12-2001
 COMENTARIOS:	Tramo 00 del puente que lleva a los cultivos, en Koek
 ***************************************************************************************/
...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/calles/folker_01"));
 AddExit("sur",RHOEHAB("koek/campos/puente_01"));
 ...
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W("Estás en el comienzo del puente que lleva a los campos "
