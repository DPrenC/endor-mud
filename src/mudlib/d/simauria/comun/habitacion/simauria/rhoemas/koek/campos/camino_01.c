...
create () {
 ...
 AddExit("norte",RHOEHAB("koek/campos/camino_00"));
 AddExit("sur",RHOEHAB("koek/campos/camino_04"));
 AddDetail(({"camino"}),SF(fcamino));
 AddDetail(({"puente"}),"Casi no alcanzas a ver el puente hacia el norte.\n");
 ...
 if (CHRONOS->QueryEstacion()==1)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de "
 		...
 		"por unas huellas en la nieve. Muy al norte puedes ver el "
 	...
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"Desde aquí divisas el río, muy al norte, cruzado por el puente. "
 ...
 if (CHRONOS->QueryEstacion()==2)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de cultivos "
 		...
 		"toque de colorido al camino. Muy al norte puedes ver el puente que "
 	...
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"El río Hedrikon discurre muy por el norte bajo el puente. Ahora "
 ...
 if (CHRONOS->QueryEstacion()==3)
 {
 	SetIntLong(W("Estás en el camino que lleva a los campos de cultivos "
 		...
 		"colorido. Muy al norte puedes ver el puente que cruza el río "
 	...
 	AddDetail(({"río","río","río hedrikon","río hedrikon","río hedrikon","río Hedrikon","hedrikon","Hedrikon"}),W(
 		"El río Hedrikon discurre muy por el norte bajo el puente.\n"));
 	AddDetail(({"hierba","hierbas","pequeña hierba","pequeñas hierbas"}),W(
 		"Algunas hierbas salvajes crecen a los lados del camino.\n"));
