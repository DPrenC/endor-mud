/***************************************************************************************
 ...
 AUTOR:		[z] Zomax
 FECHA:		01-11-2001
 COMENTARIOS:	Viñedo nº 01, en Koek.
 ***************************************************************************************/
...
create () {
 ...
 AddExit("sur",RHOEHAB("koek/campos/vinyedo_04"));
 AddExit("este",RHOEHAB("koek/campos/vinyedo_02"));
 AddExit("oeste",RHOEHAB("koek/campos/vinyedo_00"));
