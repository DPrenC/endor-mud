/****************************************************************************
Fichero: /d/simauria/comun/habitacion/sherek/aldea/pradera/pradera40.c
Autor: Lug y Yalin
Fecha: 19/08/2006
...
create()
{
    ...
    AddExit("norte", SHERALD("pradera/pradera30"));
    AddExit("sur", SHERALD("pradera/pradera50"));
    AddExit("oeste", SHERALD("pradera/pradera41"));
    poner_pnj();
}
