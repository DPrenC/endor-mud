/****************************************************************************
Fichero: /d/simauria/comun/habitacion/sherek/aldea/pradera/pradera20.c
Autor: Lug y Yalin
Fecha: 19/08/2006
...
create()
{
    ...
    AddExit("norte", SHERALD("pradera/pradera10"));
    AddExit("sur", SHERALD("pradera/pradera30"));
    AddExit("oeste", SHERALD("pradera/pradera21"));
    poner_pnj();
}
