...
create()
{
    ...
    "por él.\nLos arbustos del bajo monte impiden ir en cualquier "
    "otra dirección que no sea la que propone este sendero.\n");
    SetIntSmell("Huele a campo.\n");
    SetIntNoise("Oyes el fuerte estruendo de la corriente de agua en el "
        "cauce del río Kandal, lejos, al suroeste.\n");
    ...
    AddExit("nordeste", SHERALD("calles/caminorio02"));
    AddExit("sur", SHERALD("calles/caminorio04"));
