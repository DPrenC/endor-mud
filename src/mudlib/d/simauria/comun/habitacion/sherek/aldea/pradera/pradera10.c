/****************************************************************************
Fichero: /d/simauria/comun/habitacion/sherek/aldea/pradera/pradera10.c
Autor: Lug y Yalin
Fecha: 19/08/2006
...
create()
{
    ...
    AddExit("norte", SHERALD("pradera/pradera00"));
    AddExit("sur", SHERALD("pradera/pradera20"));
    AddExit("oeste", SHERALD("pradera/pradera11"));
    poner_pnj();
}
