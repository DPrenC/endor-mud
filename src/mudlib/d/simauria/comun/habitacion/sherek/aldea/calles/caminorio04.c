...
create()
{
    ...
    SetIntLong("Estás en un estrecho camino que desciende desde la aldea de Sloch hacia el río "
    "Kandal, tiene mucha pendiente, lo que hace que sea complicado subir o bajar con mucha carga "
    "por él.\nLos arbustos del bajo monte impiden ir en cualquier otra dirección que no sea la "
    "que propone este sendero. Al suroeste de aquí puedes ver el cauce del río Kandal.\n");
    SetIntSmell("Huele a campo.\n");
    SetIntNoise("Puedes escuchar el fuerte sonido del agua del río al bajar "
        "encajonada entre rocas.\n");
    AddDetail(({"suelo"}), "Está formado por tierra endurecida de tanto ser "
        "pisada por los viandantes que caminan por aquí. En algunos lugares está salpicado por grandes lajas planas.\n");
    ...
    AddDetail(({"rio", "río", "Kandal", "cauce"}), "Es el cauce del Río encajado "
        "Kandal que pasa entre grandes rocas. Tiene bastante fuerza, por lo "
        "que no sería buena cosa caerse aquí al agua.\n");
