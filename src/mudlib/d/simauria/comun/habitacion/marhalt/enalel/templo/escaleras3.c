...
create() {
  ...
  "rodeándola. Las escaleras ascienden por el norte y descienden por el suroeste.\n"));
  ...
  AddExit("suroeste",ENALHAB"templo/escaleras2");
  AddExit("norte",ENALHAB"templo/escaleras4");
}