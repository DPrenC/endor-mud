...
create() {
  ...
  "se respira en el ambiente. La sensación se hace más fuerte hacia el norte. Hay "
  "senderos hacia el este, norte y el oeste.\n"));
  ...
  AddExit("este",ENALHAB"poblado/manzanal/manzanal05");
  AddExit("oeste",ENALHAB"poblado/manzanal/manzanal07");
  AddExit("norte",ENALHAB"poblado/manzanal/manzano00");
