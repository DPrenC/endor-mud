...
create() {
  ...
  SetIntLong(W("Estás en el manzanal de Fhainfos. Los manzanos que aquí se pueden "
  "ver son más grandes y frondosos que cualquiera de los que hayas visto antes en "
  "tu vida. Hay senderos hacia el este y el oeste.\n"));
  ...
  AddExit("este",ENALHAB"poblado/manzanal/manzanal01");
  AddExit("oeste",ENALHAB"poblado/manzanal/manzanal03");
