...
create() {
    ...
    AddDetail(({"cama","muebles","mueble","moviliario"}),"Todo en este "
    "dormitorio está hecho de la mejor madera que se pueda encontrar.\n");

   AddExit("sur",ENALHAB"poblado/casas/benjus/pasillo4");
