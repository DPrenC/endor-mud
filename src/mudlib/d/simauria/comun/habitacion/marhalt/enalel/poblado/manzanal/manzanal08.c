...
create() {
  ...
  SetIntLong(W("Estás en el manzanal de Fhainfos. "
  "Grandes manzanos se alinean para formar los senderos de este pequeño bosque.\n"
  "Hay senderos hacia el norte y el sur.\n"));
  ...
  AddDetail(({"manzano","manzanos","manzanal"}),W("Son unos enormes manzanos "
  "cuya corteza es dorada y sus frutos son más grandes que el resto."));
  AddDetail(({"manzana","manzanas","fruto","frutos"}),W("Las manzanas están muy "
  "altas, parecen muy grandes y jugosas.\n"));
  AddExit("norte",ENALHAB"poblado/manzanal/manzanal03");
  AddExit("sur",ENALHAB"poblado/manzanal/manzanal07");
