...
create() {
  ...
  "ya que es aquí donde crecieron los primeros manzanos de Enalel. Una extraña sensación "
  "te hace pensar que un aire mágico se respira en el ambiente. Hay senderos hacia el "
  "norte y el este.\n"));
  ...
  AddDetail(({"manzano","manzanos","manzanal"}),W("Son unos enormes manzanos cuya corteza "
  "es dorada y sus frutos son más grandes que el resto."));
  AddDetail(({"manzana","manzanas","fruto","frutos"}),W("Las manzanas están muy altas, "
  "parecen muy grandes y jugosas.\n"));
  AddExit("este",ENALHAB"poblado/manzanal/manzanal06");
  AddExit("norte",ENALHAB"poblado/manzanal/manzanal08");
