...
create(){
    ...
    SetIntLong("A orillas del ensanchamiento que forma el río Kandal en una de sus "
        ...
        "invertebrados.\n El cañaveral continúa por el noroeste.\n");
    AddDetail(({"suelo", "barro", "cañaveral"}), "En esta zona de la orilla del río "
        "se ha formado en el suelo una pequeña capa de barro donde las aves escarban "
        "buscando su comida. El cañaveral continúa hacia el noroeste.\n");
    AddDetail(({"gusano", "gusanos", "cebo", "invertebrados", "invertebrado",
        "pequeño invertebrado", "pequeños invertebrados", "lombriz", "lombrices"}),
        "Se esconden en el barro, tendrás que removerlo y escarbar para encontrar lo "
        "que necesitas.\n");
    ...
    AddExit("noroeste","./bosque026");
    AddExit("este","./bosque029");
    AddExit("sudeste", "./bosque034");
