...
create(){
    ::create();
    SetIntShort("una pequeña sala común");
    SetIntLong("Esta es una pequeña sala común para parte de la guarnición del "
    "castillo. Unos pocos bancos y caballetes es lo único que se puede apreciar de "
    "interés en la estancia.\n");
