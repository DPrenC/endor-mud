...
create(){
    ::create();
    SetIntShort("la muralla, al oeste de la puerta del castillo");
    ...
    "Al oeste se encuentran las poleas que maniobran el puente levadizo protegidas por "
    ...
    AddExit("este", "./muralla08");
    AddExit("sur", "./muralla06");
    AddExit("arriba", "./garita_oeste");
}
