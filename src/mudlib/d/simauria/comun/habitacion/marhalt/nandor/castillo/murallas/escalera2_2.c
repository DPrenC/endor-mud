...
create(){
    ...
    "Al suroeste, atravesando un arco de piedra se llega a una amplia sala.\n");
    ...
    AddExit("suroeste", "./torre2_08");
    AddExit("abajo", "./escalera2_1");
    AddExit("arriba", "./escalera2_3");
    }
