    /****************************************************************************
    Fichero: garita_este.c
    Autor: Ratwor
    Fecha: 22/01/2008
    Descripción: Una garita para los lados de la puerta del castillo
    ****************************************************************************/
#include "./path.h"
...
create(){
    ...
    "mecanismo que lo mueve. Algo mas al oeste ves una torrecilla similar, mientras "
