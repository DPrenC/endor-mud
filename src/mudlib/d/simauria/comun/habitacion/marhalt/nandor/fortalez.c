...
switch(random(100))
   ...
   case 30..32:AddItem(PNJFF("conjurat"),REFRESH_DESTRUCT,1);break;
   case 33..39:AddItem(PNJFF("ladron"),REFRESH_DESTRUCT,1);break;
...
create()
{
  ...
  SetIntLong(W("Estás en la fortaleza de Cored. La fortaleza está en muy buen "
