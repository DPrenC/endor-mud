...
create(){
    ...
    "Inmolación al oeste.\n"
    "Aquí la muralla se curva hacia el norte, adelantándose para formar el baluarte de "
    ...
    "escaleras.\n");
    AddExit("norte", "./muralla07");
    AddExit("oeste", "./muralla05");
    AddExit("abajo", CASTILLO("patio/patio04"));
}
