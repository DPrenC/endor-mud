...
create(){
    ...
    "La muralla continúa hacia el sur hasta la torre de la Dama y al norte.\n Al este, "
    "mas allá del foso la ladera de la colina desciende hacia el camino norte de "
    "Marhalt y la aldea de Nandor.\n");
    ...
    "extienden los campos de cultivo, al sudeste el río Kandal y el bosque de Marhalt, y al "
    ...
    "nada para evitarlo.\n");
    AddExit("sur", "./muralla20");
    AddExit("norte", "./muralla18");
}
