...
create(){
    ...
    "norte de la planta baja del torreón de Cónor. Es aquí donde la servidumbre del castillo "
    ...
    "lugar.\n Los barracones continúan hacia el este.\n");
    ...
    AddExit("sur", "./torre2_04");
    AddExit("este", "./torre2_02");
