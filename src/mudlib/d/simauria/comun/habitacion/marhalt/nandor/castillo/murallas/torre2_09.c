...
create(){
    ::create();
    SetIntShort("la parte superior del torreón de Cónor");
    SetIntLong("Estás en la parte alta del torreón de Cónor, un amplio espacio "
    ...
    AddDetail("suelo", "El suelo está formado por pesadas losas de piedra gris.\n");
    AddExit("norte", "./torre2_10");
    AddExit("noroeste", "./escalera2_3");
    AddExit("oeste", "./torre2_12");
}
