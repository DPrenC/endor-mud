...
create(){
    ...
    "Marhalt.\n"
    "Al este la muralla dobla en un recodo hacia el norte junto a la espigada torre de "
    "la Dama mientras que al oeste se extiende hasta la torre del homenaje.\n");
    ...
    "nada para evitarlo.\n");
    AddExit("oeste", "./muralla22");
    AddExit("este", "./muralla20");
}
