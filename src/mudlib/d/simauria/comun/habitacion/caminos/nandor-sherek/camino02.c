/*
Archivo: /d/simauria/comun/habitacion/caminos/nandor-sherek/camino02.c
Autor:         Yalin y Lug
Fecha:         30/04/2006
...
create()
{
    ...
    AddDetail(({"muro", "muros", "muralla", "murallas"}), "Parece ser la muralla de un "
        "cementerio.\n");
    AddExit("oeste", CNSH("camino01"));
    AddExit("este", CNSH("camino03"));
    AddExit("sur", MARH("nandor/bosque/bosque002"));
    Bichejo();
}
