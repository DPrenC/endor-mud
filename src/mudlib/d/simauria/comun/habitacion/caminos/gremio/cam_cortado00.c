...
create() {
    ::create();
    SetIntLong(" Te encuentras en una angosta garganta, excavada tiempo atrás en la roca "
    "por la acción de corrientes de agua ya desaparecidas, que corre entre   escarpadas "
    "paredes ensanchándose un poco mas al noroeste, para formar un abrupto desfiladero "
    "que penetra en el pétreo corazón de la cordillera, mientras que al sudeste "
    ...
    "rastreras con las que sería muy fácil enrredarse.\n");
