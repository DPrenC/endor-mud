...
create(){
    ...
    "ruta que comunica la pequeña población agrícola de Nandor con el poblado de Enalel"
    ", en el lejano norte, y con las aún más distantes montañas septentrionales. Su "
    "construcción se remonta a los tiempos de los primeros hombres y los grandes señores "
    "de Ishtria, cuando florecían las alianzas comerciales y militares entre hombres y "
    "semi elfos, y decenas de caravanas mercantes recorrían diariamente la gran distancia "
    "que separa ambas regiones.\n En aquellos tiempos el camino estaba adoquinado "
    "con enormes losas graníticas de corte exagonal que ahora aparecen resquebrajadas, "
    ...
    "cuya cima, el castillo parece cernirse sobre los viajeros. Se podría llegar a "
    "notar, clavarse en los caminantes, la mirada atenta de los vigías apostados en las "
    "torres y la muralla, lo que anima a cualquiera a apurar el paso.\n Hacia el noroeste"
    ", el camino continúa, serpenteando junto al abrupto terraplén que forma la falda "
    ...
    "y raíces inicia un vertiginoso ascenso por el escarpado terraplén, zigzagueando "
    "entre grandes rocas y árboles torcidos hasta perderse de vista varios metros más "
    "arriba.\n Por el sur, una pequeña zona agrícola se extiende hacia el límite del río.\n");
AddDetail(({"rio", "río", "kandal", "Kandal"}),
    ...
    //AddExit("sur", (:write("Ese es el camino que va hacia las granjas del oeste del cruce de la araña.\n"); return 1;:));
}
