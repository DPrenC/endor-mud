...
create(){
    ::create();
    SetIntLong(QueryIntLong()+" Justo al este se puede apreciar un cruce de este camino, "
    "donde se separa otro también empedrado hacia el sur, en dirección a la entrada del "
    "castillo.\n");
    ...
    AddExit("oeste", "./camino41");
    AddExit("este", "./camino39");
}
