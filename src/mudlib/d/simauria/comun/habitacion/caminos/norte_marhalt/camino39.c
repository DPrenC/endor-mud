...
create(){
    ...
    SetIntLong(QueryIntLong()+"Hacia el sur, un ancho sendero, pavimentado con losas "
    "rectangulares de evidente manufactura reciente, asciende casi en línea recta "
    "por la ahora suave falda de la colina, directo hasta las puertas principales del "
    "castillo, justo sobre ti.\n");
    ...
    AddExit("oeste", "./camino40");
    AddExit("este", "./camino38");
    AddExit("sur", CASTILLO("camino/camino36"));
}
