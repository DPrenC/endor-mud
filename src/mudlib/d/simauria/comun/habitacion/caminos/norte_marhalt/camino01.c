...
create(){
    ...
    " de la larga ruta que comunica la pequeña población agrícola de Nandor con el "
    "poblado de Enalel, en el lejano norte, y con las aún más distantes montañas "
    "septentrionales.\n Su construcción se remonta a los tiempos de los primeros hombres "
    "y los grandes señores de Ishtria, cuando florecían las alianzas comerciales "
    "y militares entre humanos y medio elfos, y decenas de caravanas mercantes "
    "recorrían diariamente la gran distancia que separa ambas localidades.\n En aquellos "
    "tiempos el camino estaba adoquinado con enormes losas graníticas de corte exagonal "
    ...
    "los Dhes-Bláin, que se alza en lo alto de una escarpada colina, hacia el oeste.\n");
    ...
    "a intervalos irregulares el reflejo plateado de las aguas del río Kandal, que "
    "discurren tranquilas hacia el suroeste.\n");
    AddDetail(({"rio", "río", "aguas", "agua", "kandal", "Kandal"}),
    "Desde aquí alcanzas a vislumbrar entre la variedad de colores del bosque de Marhalt "
    "un reflejo irregular, cuando plateado, cuando dorado o verdoso, que son las "
    "aguas del río Kandal, que discurren con suavidad hacia el oeste, hacia tierras más "
