...
sitio para calmar tu sed si bebes un poco del agua clara del Cashigan.\n");
 ...
 AddExit("sur",BATALLA("borde_rio7"));
 AddExit("norte",BATALLA("borde_rio5"));
 AddExit("este",BATALLA("zona_combate4"));
 AddExit("nordeste",BATALLA("zona_combate3"));
 AddExit("sudeste",BATALLA("zona_combate5"));
