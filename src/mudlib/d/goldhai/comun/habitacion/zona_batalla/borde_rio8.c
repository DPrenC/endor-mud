...
sitio para calmar tu sed si bebes un poco del agua clara del Cashigan.\n");
 ...
 AddExit("norte",BATALLA("borde_rio7"));
 AddExit("este",BATALLA("zona_combate6"));
 AddExit("nordeste",BATALLA("zona_combate5"));
 AddExit("oeste",BATALLA("borde_rio9"));
 AddExit("suroeste",BATALLA("borde_rio10"));
