...
sitio para calmar tu sed si bebes un poco del agua clara del Cashigan.\n");
 ...
 AddExit("sur",BATALLA("borde_rio2"));
 AddExit("norte",BATALLA("borde_rio4"));
 AddExit("este",BATALLA("zona_combate25"));
 AddExit("nordeste",BATALLA("borde_rio13"));
 AddExit("sudeste",BATALLA("zona_combate1"));
