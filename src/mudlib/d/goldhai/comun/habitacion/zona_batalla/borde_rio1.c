...
sitio para calmar tu sed si bebes un poco del agua clara del Cashigan.\n");
 ...
 AddExit("sur",BATALLA("borde_rio5"));
 AddExit("norte",BATALLA("borde_rio2"));
 AddExit("este",BATALLA("zona_combate2"));
 AddExit("nordeste",BATALLA("zona_combate1"));
 AddExit("sudeste",BATALLA("zona_combate3"));
