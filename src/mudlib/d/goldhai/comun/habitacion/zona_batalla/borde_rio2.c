...
sitio para calmar tu sed si bebes un poco del agua clara del Cashigan.\n");
 ...
 AddExit("oeste",BWALD("puente"));
 AddExit("sur",BATALLA("borde_rio1"));
 AddExit("norte",BATALLA("borde_rio3"));
 AddExit("este",BATALLA("zona_combate1"));
 AddExit("nordeste",BATALLA("zona_combate25"));
 AddExit("sudeste",BATALLA("zona_combate2"));
