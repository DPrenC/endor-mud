...
sitio para calmar tu sed si bebes un poco del agua clara del Cashigan.\n");
 ...
 AddExit("sur",BATALLA("borde_rio8"));
 AddExit("norte",BATALLA("borde_rio6"));
 AddExit("este",BATALLA("zona_combate5"));
 AddExit("nordeste",BATALLA("zona_combate4"));
 AddExit("sudeste",BATALLA("zona_combate6"));
