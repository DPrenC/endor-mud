...
create()
{
    ...
    SetIntShort("la habitación 3 de la posada");
    ...
    AddExit("sureste", "./posada03_atrio");
    AddDoor("sureste", "la puerta de salida", 
    "Es una puerta de madera simple que sale al atrio de la posada.\n",
    ({"puerta del atrio", "puerta de madera", "puerta de salida", "puerta", "puerta sudeste",
     "puerta del sudeste"}));
}
