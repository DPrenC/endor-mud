...
create()
{
    ...
    SetIntShort("un denso bosque");
    SetIntLong("Estás en un espeso bosque de recios árboles centinela resguardados tras "
    ...
    AddExit("oeste", HAB_BOSQUE_ISLA("robledal16.c"));
    AddExit("suroeste", HAB_BOSQUE_ISLA("robledal12.c"));
}
