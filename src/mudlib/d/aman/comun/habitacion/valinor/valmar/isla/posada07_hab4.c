...
create()
{
    ...
    SetIntShort("la habitación 4 de la posada");
    ...
    AddExit("suroeste", "./posada03_atrio");
    AddDoor("suroeste", "la puerta de salida", 
    "Es una puerta de madera simple que sale al atrio de la posada.\n",
    ({"puerta del atrio", "puerta de madera", "puerta de salida", "puerta", "puerta suroeste",
     "puerta del suroeste"}));
}
