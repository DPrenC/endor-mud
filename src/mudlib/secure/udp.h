...
#define UDP_CMD_DIR	"/secure/inetd/udp/"
#define HOST_FILE	"/secure/inetd/INETD_HOSTS"
...
#define LOCAL_NAME	"Nightfall"
#else
#define LOCAL_NAME	MUDNAME "-" __HOST_NAME__
#endif
#else	/* __HOST_NAME__ */
#define LOCAL_NAME	(MUDNAME+(__HOST_NAME__ == "quest"?"":"-"+__HOST_NAME__))
#endif	/* __HOST_NAME__ */
#endif /* !LOCAL_NAME */
