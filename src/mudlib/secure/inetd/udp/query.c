...
#ifdef ZEBEDEE
#define EMAIL	"nostra@city.ac.uk"
#elif __HOST_NAME__ == "quest"
#define EMAIL	"gamesmgr@quest.tat.physik.uni-tuebingen.de"
#elif __HOST_NAME__ == "nova"
#define EMAIL	"gamesmgr@nova.tat.physik.uni-tuebingen.de"
#else
#define EMAIL	"/dev/null"
#endif
