/* SIMAURIA '/std/magia/m_armour.c'
   ...
   Protección mágica a heredar en los conjuros de creación.
   26-11-99 [w] Creación.
*/
...
/* 'power' es el tiempo en que la armadura permanecerá antes de ser destruida. */
...
create()
{
 ...
 seteuid(getuid());
  ...
  SetShort("un casco mágico");
  SetLong("Un estupendo casco mágico.\n");
  Set(P_NOGIVE, 1);
  Set(P_NOGET, 1);
  Set(P_NOSELL, 1);
  SetMagic("Esta protección ha sido creada por algún mago.\n");
  SetAPperQP(0);
  SetPowerDesc(
